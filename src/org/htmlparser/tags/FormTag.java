...
public class FormTag extends CompositeTag {
    ...
    public String getFormLocation() {
        if (null == mFormLocation)
            // ... is it true that without an ACTION the default is to send it back
            // to the same page?
    ...
    public InputTag getInputTag(String name) {
        ...
        for (SimpleNodeIterator e = getFormInputs().elements(); e.hasMoreNodes() && !found; ) {
            ...
            if (inputTagName != null && inputTagName.equalsIgnoreCase(name)) found = true;
        }
        if (found)
            return (inputTag);
        else
    ...
    public TextareaTag getTextAreaTag(String name) {
        ...
        for (SimpleNodeIterator e = getFormTextareas().elements(); e.hasMoreNodes() && !found; ) {
            ...
            if (textAreaName != null && textAreaName.equals(name)) found = true;
        }
        if (found)
            return (textareaTag);
        else
    ...
    public String toString() {
        return "FORM TAG : Form at " + getFormLocation() + "; begins at : " + getStartPosition()
    ...
    public String extractFormLocn() {
        ...
        if (null == ret)
            ret = "";
        else if (null != getPage()) ret = getPage().getAbsoluteURL(ret);
