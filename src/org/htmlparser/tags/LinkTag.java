...
public class LinkTag extends CompositeTag {
     ...
     */
    private static final String[] mEnders = new String[]{"A", "P", "DIV", "TD", "TR", "FORM",
            "LI"};

    /**
     * The set of end tag names that indicate the end of this tag.
     */
    private static final String[] mEndTagEnders = new String[]{"P", "DIV", "TD", "TR", "FORM",
            "LI", "BODY", "HTML"};
    ...
    public String toString() {
        ...
        sb.append("Link to : " + getLink() + "; titled : " + getLinkText() + "; begins at : "
                + getStartPosition() + "; ends at : " + getEndPosition() + ", AccessKey=");
    ...
    public String extractLink() {
        ...
        if (null != getPage()) ret = getPage().getAbsoluteURL(ret);
