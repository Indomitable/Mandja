...
public class TableRow extends CompositeTag {
    ...
    public TableColumn[] getColumns() {
        ...
        if (null != kids) {
            ...
            filter = new OrFilter(new AndFilter(cls, new IsEqualFilter(this)), new AndFilter( // recurse
                    // up
                    // the
                    // parent
                    // chain
            ...
            kids = kids.extractAllNodesThatMatch(
                    ...
                    new AndFilter(new NodeClassFilter(TableColumn.class), filter), true);
    ...
    public TableHeader[] getHeaders() {
        ...
        if (null != kids) {
            ...
            kids = kids.extractAllNodesThatMatch(
                    ...
                    new AndFilter(new NodeClassFilter(TableHeader.class), filter), true);
