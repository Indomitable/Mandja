...
public abstract class Source extends Reader implements Serializable {
     ...
     * the mark() operation.
     *
     * @param readAheadLimit The minimum number of characters that can be read before this
     ...
     * @throws IOException If the source is closed or the offset is beyond
     *                     {@link #offset()}.
     */
     ...
     * @throws IOException If the source is closed or the start or end is beyond
     *                     {@link #offset()}.
     */
     ...
     * @param offset The offset of the first character.
     * @param length The number of characters to retrieve.
     * @throws IOException If the source is closed or the offset or (offset + length)
