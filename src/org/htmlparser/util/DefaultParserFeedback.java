...
public class DefaultParserFeedback implements ParserFeedback, Serializable {
    ...
    public void info(String message) {
        if (QUIET != mMode) System.out.println("INFO: " + message);
    }
    ...
    public void warning(String message) {
        if (QUIET != mMode) System.out.println("WARNING: " + message);
    }
    ...
    public void error(String message, ParserException exception) {
        if (QUIET != mMode) {
            ...
            if (DEBUG == mMode && (null != exception)) exception.printStackTrace();
        }
    }
}
