...
public class HasChildFilter implements NodeFilter {
     ...
     * @param recursive If <code>true</code>, any enclosed node acceptable to the
     ...
     *
     * @return Returns <code>true</code> if the filter is recursive up the node
     *         heirarchy.
     */
    ...
    public boolean accept(Node node) {
        ...
        if (node instanceof CompositeTag) {
            ...
            if (null != children) {
                ...
                if (!ret && getRecursive()) for (int i = 0; !ret && i < children.size(); i++)
