 ...
 * text with something like the {@link org.htmlparser.beans.StringBean
 * StringBean} and then apply the regular expression.
 * <p/>
...
public class RegexFilter implements NodeFilter {
     ...
     *                 <ol>
     *                 <li>{@link #MATCH} use matches() method: attempts to match the
     *                 entire input sequence against the pattern</li>
